...
the number of times that the if statement is executed.for (int rupee20=0; rupee20<=__; rupee20++)
...
int countRepresentations(int numRupees);
int main(){
    printf("number of way to represent 12 rrupee is: %d\n",countRepresentations(12));
     printf("number of way to represent 50 rrupee is: %d\n",countRepresentations(50));
    return 0;
}
